...
import imagePlaceholder from "../../../attached_assets/Placeholder.jpg"; // Adjust the import path as necessary
  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        >
          <span className="text-electric">Hello,</span>
          <br />
        ...
        >
          Computer Science student passionate about creating responsive web
          applications and building seamless user experiences with React.js and
          modern technologies.
        </motion.p>
        ...
        >
          ...
          <motion.button
            ...
            onClick={() =>
              window.open(
                "../../../attached_assets/SAM Resume_1752243143120.pdf",
                "_blank"
              )
            }
          >
